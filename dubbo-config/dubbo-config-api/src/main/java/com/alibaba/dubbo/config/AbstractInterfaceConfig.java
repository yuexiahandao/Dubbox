...
public abstract class AbstractInterfaceConfig extends AbstractMethodConfig {
    ...
    protected void checkApplication() {
        ...
        // 设置一些属性
        // 注意这里是ApplicationConfig没有配置为Bean的时候（ServiceBean的属性没有设置），才会去读取Properties文件。
        // 如果是Bean的方式定义，这里指定了application，那么这个application的默认值是怎么实现的，
        // 还要去看ApplicationBean的类的实现，这就是Dubbo配置的相互实现方式。
    ...
    /**
     * 加载本地实现类，与存根，return类型的mock和普通的mock配置
